...
// prevent maxValue to be smaller than minValue
// or maxValue input to be empty
// or maxValue to be bigger than 13 000
...
$('.catalog__view__icons__link-grid').on("click", function (e){
  e.preventDefault();
...
// catalog view - list
$('.catalog__view__icons__link-list').on("click", function (e){
  e.preventDefault();
